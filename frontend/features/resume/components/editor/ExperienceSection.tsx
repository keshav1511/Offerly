...
export function ExperienceSection({ register, errors, control }: ExperienceSectionProps) {
      ...
      <div className="flex items-center justify-between border-b border-zinc-100 dark:border-zinc-900/60 pb-2">
        <div>
          ...
          <p className="text-[10px] text-zinc-400 dark:text-zinc-500 font-mono mt-1">
            Manage your employment history, roles, and job descriptions.
          </p>
        </div>
        <Button
          type="button"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    ...
                    <textarea
                      ...
                      placeholder="Describe your key impact, projects, and technologies used..."
                    />
                  </div>
                </div>
              </div>
