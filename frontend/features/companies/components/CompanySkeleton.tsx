  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {Array.from({ length: 6 }).map((_, index) => (
        <div
          key={index}
          className="border border-zinc-200 dark:border-zinc-800 rounded-lg p-5 bg-white dark:bg-zinc-950 animate-pulse flex flex-col justify-between h-44 shadow-sm"
        >
          <div>
            ...
            <div className="space-y-2">
              <div className="h-2.5 bg-zinc-100 dark:bg-zinc-900 rounded w-4/5" />
              <div className="h-2.5 bg-zinc-100 dark:bg-zinc-900 rounded w-2/3" />
            </div>
          </div>
          <div className="border-t border-zinc-100 dark:border-zinc-900/60 pt-3 flex items-center justify-between mt-4">
            ...
            <div className="h-3 bg-zinc-100 dark:bg-zinc-900 rounded w-1/5" />
          </div>
        </div>
      ))}
    </div>
